...
double potencia(double base, int expoente) {
    ...
    return resultado;
}int quadrado(int x){return x*x;}int main(){printf("2^2 = %0.f\n",pow(2,2));printf("This is a test\n");int a=5;int b=10;int resultado=0;resultado=quadrado(a)+quadrado(b);printf("Resultado: %d\n",resultado);if(resultado>50){for(int i=0;i<5;i++){printf("Iteração: %d\n",i);}}return 0;}